      ...
      <div className="flex-1 flex flex-col gap-4">
        ...
        <div className="glossy-panel">
          <div className="flex justify-between items-center mb-2">
            ...
            <button onClick={addFrame} className="bg-green-600 text-white px-3 py-1 rounded text-sm hover:bg-green-700">+ {t('Add Frame')}</button>
          </div>
            ...
            <div className="border-t pt-2 mt-2">
              <div className="flex justify-between items-center mb-2">
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={() => fileInputRef.current?.click()} className="bg-blue-600 text-white px-2 py-1 rounded text-xs">{t('Upload Image')}</button>
                  <button onClick={handleAddImageUrl} className="bg-green-600 text-white px-2 py-1 rounded text-xs">{t('Add URL')}</button>
                </div>
              </div>
